...
type
  TfrmLiveUpdates = class(TfrmMainQueryBase)
    ...
    ts1: TTabSheet;
    mmoLog: TMemo;
    VistaDBTable1: TVistaDBTable;
    procedure btnConnectClick(Sender: TObject);
    procedure FormCreate(Sender: TObject);
    procedure VistaDBTable1UpdateRecord(Sender: TObject;
...
begin
  inherited;
  RegisterDS(VistaDBTable1);
end;

procedure TfrmLiveUpdates.VistaDBTable1UpdateRecord(Sender: TObject;
  EventArgs: TRowUpdatedEventArgs);
var
  oMsg: string;
begin
