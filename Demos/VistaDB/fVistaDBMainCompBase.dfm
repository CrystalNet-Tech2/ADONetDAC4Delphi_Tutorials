object frmVistaDBMainCompBase: TfrmVistaDBMainCompBase
  Left = 0
  Top = 0
  Caption = 'VistaDB Main Component Base'
  ClientHeight = 559
  ClientWidth = 586
  Color = clBtnFace
  ...
  object pnlMain: TPanel
    ...
    object pnlConnDef: TPanel
      ...
      object edtDB: TEdit
        ...
        Margins.Bottom = 2
        TabOrder = 0
        Text = 'C:\Users\Public\Documents\VistaDB 5\Databases\Northwind.vdb5'
      end
      object edtPwd: TEdit
        Left = 98
        Top = 31
  ...
  object VistaDBConnection1: TVistaDBConnection
    Left = 488
    Top = 85
  end
end
