inherited frmMasterDetail: TfrmMasterDetail
  ...
  object dsCustomers: TDataSource
    AutoEdit = False
    DataSet = VistaDBQueryCustomers
    Left = 288
    Top = 296
  end
  object dsOrders: TDataSource
    AutoEdit = False
    DataSet = VistaDBQueryOrders
    Left = 316
    Top = 471
  end
  object VistaDBQueryCustomers: TVistaDBQuery
  ...
  object VistaDBQueryOrders: TVistaDBQuery
    Connection = VistaDBConnection1
    UpdateOptions.UpdateMode = umBatch
    UpdateOptions.ReadOnly = True
    UpdateOptions.RequestLive = False
    ...
    Parameters = <
      item
        ...
        Value = Null
        IsNullable = True
        SourceVersion = drvDefault
        VistaDBType = vdbNChar
      end>
    SQL.Strings = (
