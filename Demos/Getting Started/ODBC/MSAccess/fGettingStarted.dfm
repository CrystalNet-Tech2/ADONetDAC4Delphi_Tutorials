object frmGettingStarted: TfrmGettingStarted
  ...
  object OdbcQueryCustomers: TOdbcQuery
    Connection = OdbcConnection1
    Parameters = <>
    SQL.Strings = (
  ...
  object OdbcConnection1: TOdbcConnection
    ...
    Params.Driver = '{Microsoft Access Driver (*.mdb)}'
    Params.ConnectionString = 'Driver={Microsoft Access Driver (*.mdb)}'
    LoginPrompt = False
    Left = 200
    Top = 384
  end
