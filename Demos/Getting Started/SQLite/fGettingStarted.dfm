object frmGettingStarted: TfrmGettingStarted
  ...
  object pnlMain: TPanel
    ...
    object pnlConnDef: TPanel
      ...
      object edtDB: TEdit
        ...
        Margins.Bottom = 2
        TabOrder = 0
        Text = '..\..\DB\Data\SQLite\Northwind.sqlite'
      end
      object edtPwd: TEdit
        Left = 98
        Top = 30
  ...
  object dlgOpen: TOpenDialog
    DefaultExt = '*.sqlite'
    Filter = 
      'All SQLite databases|*.db;*.sdb;*.sqlite;*.db3;*.s3db;*.sqlite3;' +
      '*.sl3;*.db2;*.s2db;*.sqlite2;*.sl2|SQLite3|*.db3;*.s3db;*.sqlite' +
      '3;*.sl3|SQLite2|*.db2;*.s2db;*.sqlite2;*.sl2|All Files|*.*'
    Left = 259
    Top = 272
  end
  object SQLiteConnection1: TSQLiteConnection
    ConnectionString = 
      'pooling=True;max page count=0;synchronous=Normal;page size=4096;' +
      'version=3;read only=False;legacy format=False;journal mode=Defau' +
      'lt'
    Params.Pooling = True
    Left = 200
    Top = 410
