...
uses
  ...
  Controls, Forms, Dialogs, fODBCMainCompBase, CNClrLib.ADONet.EventArgs,
  StdCtrls, ComCtrls, DB, CNClrLib.ADONet.Client, ExtCtrls, Buttons,
  CNClrLib.ADONet.Enums, CNClrLib.ADONet.Error, CNClrLib.ADONet.OdbcEventArgs,
  CNClrLib.ADONet.Odbc;

type
  TfrmMainQueryBase = class(TfrmODBCMainCompBase)
