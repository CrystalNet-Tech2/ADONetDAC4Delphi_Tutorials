...
type
  TfrmMetaTables = class(TfrmODBCMainCompBase)
    pnl2: TPanel;
...
begin
  ...
  inherited;
  OdbcConnection1.GetTableNames(cbTable.Items);
...
begin
  if rgMain.ItemIndex = 0 then
    OdbcConnection1.GetTableNames(mmoConsole.Lines)
  else
    OdbcConnection1.GetFieldNames(cbTable.Text, mmoConsole.Lines);
