...
uses
  ...
  Controls, Forms, Dialogs, fOLEDBMainCompBase, CNClrLib.ADONet.EventArgs,
  StdCtrls, ComCtrls, DB, CNClrLib.ADONet.Client, ExtCtrls, Buttons,
  CNClrLib.ADONet.Enums, CNClrLib.ADONet.Error, CNClrLib.ADONet.OleDbEventArgs,
  CNClrLib.ADONet.OleDb;

type
  TfrmMainQueryBase = class(TfrmOLEDBMainCompBase)
