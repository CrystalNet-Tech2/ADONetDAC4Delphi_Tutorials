...
type
  TfrmLiveUpdates = class(TfrmMainQueryBase)
    ...
    ts1: TTabSheet;
    mmoLog: TMemo;
    OleDbQueryEmployees: TOleDbQuery;
    procedure btnConnectClick(Sender: TObject);
    procedure FormCreate(Sender: TObject);
    procedure OleDbQueryEmployeesUpdateRecord(Sender: TObject;
...
begin
  inherited;
  RegisterDS(OleDbQueryEmployees);
end;

procedure TfrmLiveUpdates.OleDbQueryEmployeesUpdateRecord(Sender: TObject;
  EventArgs: TRowUpdatedEventArgs);
var
  oMsg: string;
begin
