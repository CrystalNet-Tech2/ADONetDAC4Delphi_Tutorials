...
uses
  ...
  Controls, Forms, Dialogs, fOLEDBMainCompBase, CNClrLib.ADONetWrapper,
...
type
  TfrmCommands = class(TfrmOLEDBMainCompBase)
    mmoConsole: TMemo;
