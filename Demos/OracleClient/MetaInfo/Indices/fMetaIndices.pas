...
type
  TfrmMetaIndices = class(TfrmORACLEMainCompBase)
    pnl2: TPanel;
...
begin
  if rgMain.ItemIndex = 0 then
    OracleClientConnection1.GetIndexes(lbledtTableName.Text, mmoConsole.Lines)
  else
    OracleClientConnection1.GetIndexFieldNames(lbledtTableName.Text, lbledtIndexName.Text, mmoConsole.Lines);
