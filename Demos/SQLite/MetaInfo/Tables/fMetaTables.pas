...
type
  TfrmMetaTables = class(TfrmSQLiteMainCompBase)
    pnl2: TPanel;
...
begin
  ...
  inherited;
  SQLiteConnection1.GetTableNames(cbTable.Items);
...
begin
  if rgMain.ItemIndex = 0 then
    SQLiteConnection1.GetTableNames(mmoConsole.Lines)
  else
    SQLiteConnection1.GetFieldNames(cbTable.Text, mmoConsole.Lines);
