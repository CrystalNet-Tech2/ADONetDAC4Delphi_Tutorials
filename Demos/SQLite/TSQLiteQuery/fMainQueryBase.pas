...
uses
  ...
  Controls, Forms, Dialogs, fSQLiteMainCompBase,
  CNClrLib.ADONet.EventArgs, CNClrLib.ADONet.SqlEventArgs, StdCtrls,
  ComCtrls, DB, CNClrLib.ADONet.Client, CNClrLib.ADONet.SqlClient,
  ExtCtrls, Buttons, CNClrLib.ADONet.Enums, CNClrLib.ADONet.Error,
  CNClrLib.ADONet.SQLiteEventArgs, CNClrLib.ADONet.SQLite;

type
  TfrmMainQueryBase = class(TfrmSQLiteMainCompBase)
