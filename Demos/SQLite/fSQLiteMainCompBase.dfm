object frmSQLiteMainCompBase: TfrmSQLiteMainCompBase
  Left = 0
  Top = 0
  Caption = 'SQLite Main Component Base'
  ClientHeight = 559
  ClientWidth = 586
  Color = clBtnFace
  ...
  object SQLiteConnection1: TSQLiteConnection
    ConnectionString = 
      'max page count=0;synchronous=Normal;page size=4096;version=3;rea' +
      'd only=False;pooling=False;legacy format=False;journal mode=Defa' +
      'ult'
    Params.MaxPageCount = 0
    Params.SyncMode = smNormal
    Params.PageSize = 4096
    Params.Version = 3
    Params.ReadOnly = False
    Params.Pooling = False
    Params.LegacyFormat = False
    Params.JournalMode = sqljmeDefault
    DefaultTimeout = 30
    Left = 264
    Top = 93
  end
